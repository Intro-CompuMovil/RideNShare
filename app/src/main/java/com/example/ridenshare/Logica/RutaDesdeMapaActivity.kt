...
class RutaDesdeMapaActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    private fun guardarRuta(nombre: String, distancia: Double, tiempo: String, puntos: List<LatLng>) {
        ...
        // Guardar los datos de la ruta como JSON o String
        editor.putString("ruta_${nombre}", "$nombre;$distancia;$tiempo")
        editor.apply()

        Toast.makeText(this, "Ruta guardada con éxito", Toast.LENGTH_LONG).show()
    }
