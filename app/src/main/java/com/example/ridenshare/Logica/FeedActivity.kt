...
class FeedActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val bestRoutesButton = findViewById<androidx.cardview.widget.CardView>(R.id.cardBestRoutes)
        ...
        bestRoutesButton.setOnClickListener {
            startActivity(Intent(this, MejoresRutas::class.java))
        }
